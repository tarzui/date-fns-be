...
var DateFnsUtils = /** @class */ (function () {
  function DateFnsUtils(_a) {
    ...
    this.startOfYear = function (value) {
      return startOfYear_1['default'](value, { locale: _this.locale });
    };
    this.endOfYear = function (value) {
      return endOfYear_1['default'](value, { locale: _this.locale });
    };
    ...
    this.mergeDateAndTime = function (date, time) {
      return _this.setSeconds(
        _this.setMinutes(_this.setHours(date, _this.getHours(time)), _this.getMinutes(time)),
